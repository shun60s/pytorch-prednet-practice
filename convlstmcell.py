...
class ConvLSTMCell(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=1, dilation=1, groups=1, bias=True):
        ...
        self.register_buffer('wc_blank', torch.zeros(1, 1, 1, 1))  # <--- 違いあり！？ 4次の零を返す
        #self.register_buffer('wc_blank', torch.zeros(out_channels))  # webと同じにしてみるとエラーがでる
...
#-------------------------------
#  Following hard_sigmoid is borrowed from  https://github.com/huggingface/torchMoji/blob/master/torchmoji/lstm.py
#  Regarding to license, see LICENSE_torchMoji.
