...
"""
Copyright (c) 2014 Danny Price and contributors
http://github.com/telegraphic/hickle

Regarding to license, see LICENSE_hickle.
...
def _dump(py_obj, h_group, call_id=0, **kwargs):
    ...
    dumpable_dtypes = set([bool, int, float, complex, str])
